...
module SPI_Master_v2_50_0 (
	...
	cy_clock_v1_0
		#(.id("a75a8c8d-4100-4242-86a2-6ed4860079b8/426fcbe0-714d-4404-8fa8-581ff40c30f1"),
		  .source_clock_id(""),
		  .divisor(0),
		  .period("25000000"),
		  .is_direct(0),
...
module ADC_DelSig_v3_20_1 (
	...
	cy_clock_v1_0
		#(.id("8559fffa-9797-4e67-829d-3301503b471f/b7604721-db56-4477-98c2-8fae77869066"),
	...
	cy_clock_v1_0
		#(.id("8559fffa-9797-4e67-829d-3301503b471f/edd15f43-b66b-457b-be3a-5342345270c8"),
		  .source_clock_id("61737EF6-3B74-48f9-8B91-F7473A442AE7"),
		  .divisor(0),
...
module SPI_Master_v2_50_2 (
	...
	cy_clock_v1_0
		#(.id("3b2a1b93-77ae-4d9c-9b08-50ebc02a91f5/426fcbe0-714d-4404-8fa8-581ff40c30f1"),
		  .source_clock_id(""),
		  .divisor(0),
		  .period("25000000"),
		  .is_direct(0),
...
module SPI_Master_v2_50_3 (
	...
	cy_clock_v1_0
		#(.id("6fe7dcec-dea3-4647-92f9-bef8ce3c937e/426fcbe0-714d-4404-8fa8-581ff40c30f1"),
		  .source_clock_id(""),
		  .divisor(0),
		  .period("25000000"),
		  .is_direct(0),
...
// SPI_Master_v2_50(BidirectMode=false, ClockInternal=true, CtlModeReplacementString=SyncCtl, CyGetRegReplacementString=CY_GET_REG8, CySetRegReplacementString=CY_SET_REG8, DesiredBitRate=20000000, HighSpeedMode=false, InternalClockUsed=1, InternalInterruptEnabled=0, InternalRxInterruptEnabled=0, InternalTxInterruptEnabled=0, InterruptOnByteComplete=false, InterruptOnRXFull=false, InterruptOnRXNotEmpty=false, InterruptOnRXOverrun=false, InterruptOnSPIDone=false, InterruptOnSPIIdle=false, InterruptOnTXEmpty=false, InterruptOnTXNotFull=true, IntOnByteComp=0, IntOnRXFull=0, IntOnRXNotEmpty=0, IntOnRXOver=0, IntOnSPIDone=0, IntOnSPIIdle=0, IntOnTXEmpty=0, IntOnTXNotFull=1, Mode=1, ModeUseZero=1, NumberOfDataBits=8, RegDefReplacementString=reg8, RegSizeReplacementString=uint8, RxBufferSize=4, ShiftDir=0, TxBufferSize=4, UseInternalInterrupt=false, UseRxInternalInterrupt=false, UseTxInternalInterrupt=false, VerilogSectionReplacementString=sR8, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMPONENT_NAME=SPI_Master_v2_50, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=SPIM_3, CY_INSTANCE_SHORT_NAME=SPIM_3, CY_MAJOR_VERSION=2, CY_MINOR_VERSION=50, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  3.3 CP3, INSTANCE_NAME=SPIM_3, )
module SPI_Master_v2_50_4 (
	...
	cy_clock_v1_0
		#(.id("d637f9c8-d215-4daa-bc6f-8ab52e19d4a2/426fcbe0-714d-4404-8fa8-581ff40c30f1"),
		  .source_clock_id(""),
		  .divisor(0),
		  .period("25000000"),
		  .is_direct(0),
...
module top ;
    ...
    SPI_Master_v2_50_0 SPIM_0 (
        ...
        .clock(1'b0),
        .reset(1'b0),
        .rx_interrupt(Net_229),
        .sdat(Net_230),
        .tx_interrupt(Net_15));
    defparam SPIM_0.BidirectMode = 0;
    defparam SPIM_0.HighSpeedMode = 0;
    defparam SPIM_0.NumberOfDataBits = 8;
    defparam SPIM_0.ShiftDir = 0;
	...
	cy_psoc3_pins_v1_10
		#(.id("dcf6ea85-0553-403b-9441-691fb250100a"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("0996b04e-0ad0-440c-936c-90e8df91e8f6"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	wire [0:0] tmpOE__DC0_net;
	wire [0:0] tmpFB_0__DC0_net;
	wire [0:0] tmpIO_0__DC0_net;
	wire [0:0] tmpINTERRUPT_0__DC0_net;
	electrical [0:0] tmpSIOVREF__DC0_net;

	cy_psoc3_pins_v1_10
		#(.id("7e847a15-7220-47d8-8568-d1fc48d62bee"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		...
		DC0
		 (.oe(tmpOE__DC0_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__DC0_net[0:0]}),
		  .io({tmpIO_0__DC0_net[0:0]}),
		  .siovref(tmpSIOVREF__DC0_net),
		  .interrupt({tmpINTERRUPT_0__DC0_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__DC0_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	cy_psoc3_pins_v1_10
		#(.id("37933281-5ec2-4112-91e1-d4d2a2dba811"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	wire [0:0] tmpOE__RESET0_net;
	wire [0:0] tmpFB_0__RESET0_net;
	wire [0:0] tmpIO_0__RESET0_net;
	wire [0:0] tmpINTERRUPT_0__RESET0_net;
	electrical [0:0] tmpSIOVREF__RESET0_net;

	cy_psoc3_pins_v1_10
		#(.id("0997e40f-5c38-4373-b190-335b8a935e97"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		RESET0
		 (.oe(tmpOE__RESET0_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__RESET0_net[0:0]}),
		  .io({tmpIO_0__RESET0_net[0:0]}),
		  .siovref(tmpSIOVREF__RESET0_net),
		  .interrupt({tmpINTERRUPT_0__RESET0_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__RESET0_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	cy_psoc3_pins_v1_10
		#(.id("b1c60014-eacc-45c8-852b-ea4869a67c83"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("b15aa0e3-a598-477a-8432-4e3f57696852"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("772be31c-7c00-4e22-87a0-87de01354891"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("8cbb2d5c-647a-405d-8970-d5eb31628049"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("55a702d6-909e-41e5-8172-2e69937cde73"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	wire [0:0] tmpOE__RESET1_net;
	wire [0:0] tmpFB_0__RESET1_net;
	wire [0:0] tmpIO_0__RESET1_net;
	wire [0:0] tmpINTERRUPT_0__RESET1_net;
	electrical [0:0] tmpSIOVREF__RESET1_net;

	cy_psoc3_pins_v1_10
		#(.id("aa271fb8-6856-4603-8695-f549a810bd10"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		RESET1
		 (.oe(tmpOE__RESET1_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__RESET1_net[0:0]}),
		  .io({tmpIO_0__RESET1_net[0:0]}),
		  .siovref(tmpSIOVREF__RESET1_net),
		  .interrupt({tmpINTERRUPT_0__RESET1_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__RESET1_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__DC1_net;
	wire [0:0] tmpFB_0__DC1_net;
	wire [0:0] tmpIO_0__DC1_net;
	wire [0:0] tmpINTERRUPT_0__DC1_net;
	electrical [0:0] tmpSIOVREF__DC1_net;

	cy_psoc3_pins_v1_10
		#(.id("e138afce-a650-4830-aca0-1e89c5e9f1bf"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		...
		DC1
		 (.oe(tmpOE__DC1_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__DC1_net[0:0]}),
		  .io({tmpIO_0__DC1_net[0:0]}),
		  .siovref(tmpSIOVREF__DC1_net),
		  .interrupt({tmpINTERRUPT_0__DC1_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__DC1_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	cy_psoc3_pins_v1_10
		#(.id("cf719815-624f-49ff-a173-e8ef773496a8"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	wire [0:0] tmpOE__MOSI2_net;
	wire [0:0] tmpFB_0__MOSI2_net;
	wire [0:0] tmpIO_0__MOSI2_net;
	wire [0:0] tmpINTERRUPT_0__MOSI2_net;
	electrical [0:0] tmpSIOVREF__MOSI2_net;

	cy_psoc3_pins_v1_10
		#(.id("6cbeb786-82ee-4f41-bffc-4a07b5f44d8d"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		...
		MOSI2
		 (.oe(tmpOE__MOSI2_net),
		  .y({Net_152}),
		  .fb({tmpFB_0__MOSI2_net[0:0]}),
		  .io({tmpIO_0__MOSI2_net[0:0]}),
		  .siovref(tmpSIOVREF__MOSI2_net),
		  .interrupt({tmpINTERRUPT_0__MOSI2_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__MOSI2_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__MISO2_net;
	wire [0:0] tmpIO_0__MISO2_net;
	wire [0:0] tmpINTERRUPT_0__MISO2_net;
	electrical [0:0] tmpSIOVREF__MISO2_net;

	cy_psoc3_pins_v1_10
		#(.id("084dfa03-74a8-41c8-9cd9-f1f91a18b3db"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		...
		MISO2
		 (.oe(tmpOE__MISO2_net),
		  .y({1'b0}),
		  .fb({Net_155}),
		  .io({tmpIO_0__MISO2_net[0:0]}),
		  .siovref(tmpSIOVREF__MISO2_net),
		  .interrupt({tmpINTERRUPT_0__MISO2_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__MISO2_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__SCLK2_net;
	wire [0:0] tmpFB_0__SCLK2_net;
	wire [0:0] tmpIO_0__SCLK2_net;
	wire [0:0] tmpINTERRUPT_0__SCLK2_net;
	electrical [0:0] tmpSIOVREF__SCLK2_net;

	cy_psoc3_pins_v1_10
		#(.id("dacc511c-b192-4902-9362-0b78b46279fd"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		...
		SCLK2
		 (.oe(tmpOE__SCLK2_net),
		  .y({Net_153}),
		  .fb({tmpFB_0__SCLK2_net[0:0]}),
		  .io({tmpIO_0__SCLK2_net[0:0]}),
		  .siovref(tmpSIOVREF__SCLK2_net),
		  .interrupt({tmpINTERRUPT_0__SCLK2_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__SCLK2_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	cy_psoc3_pins_v1_10
		#(.id("1258f47e-ebe8-4863-abf4-055b0a296577"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	wire [0:0] tmpOE__DC2_net;
	wire [0:0] tmpFB_0__DC2_net;
	wire [0:0] tmpIO_0__DC2_net;
	wire [0:0] tmpINTERRUPT_0__DC2_net;
	electrical [0:0] tmpSIOVREF__DC2_net;

	cy_psoc3_pins_v1_10
		#(.id("f4480f3b-4eca-46cf-9e66-309174010593"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		...
		DC2
		 (.oe(tmpOE__DC2_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__DC2_net[0:0]}),
		  .io({tmpIO_0__DC2_net[0:0]}),
		  .siovref(tmpSIOVREF__DC2_net),
		  .interrupt({tmpINTERRUPT_0__DC2_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__DC2_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	cy_psoc3_pins_v1_10
		#(.id("63ef0b1e-a4cd-42c2-a8e5-5229576a6cb5"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("6ca9ab46-7df7-410d-8543-2feeac17a2f2"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
    ...
    SPI_Master_v2_50_4 SPIM_3 (
        ...
        .clock(1'b0),
        .reset(1'b0),
        .rx_interrupt(Net_243),
        .sdat(Net_244),
        .tx_interrupt(Net_160));
    defparam SPIM_3.BidirectMode = 0;
    defparam SPIM_3.HighSpeedMode = 0;
    defparam SPIM_3.NumberOfDataBits = 8;
    defparam SPIM_3.ShiftDir = 0;

	wire [0:0] tmpOE__MOSI3_net;
	wire [0:0] tmpFB_0__MOSI3_net;
	wire [0:0] tmpIO_0__MOSI3_net;
	wire [0:0] tmpINTERRUPT_0__MOSI3_net;
	electrical [0:0] tmpSIOVREF__MOSI3_net;

	cy_psoc3_pins_v1_10
		#(.id("0a7f41b9-8c8e-45bb-86d3-b4ef2137af76"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		...
		MOSI3
		 (.oe(tmpOE__MOSI3_net),
		  .y({Net_163}),
		  .fb({tmpFB_0__MOSI3_net[0:0]}),
		  .io({tmpIO_0__MOSI3_net[0:0]}),
		  .siovref(tmpSIOVREF__MOSI3_net),
		  .interrupt({tmpINTERRUPT_0__MOSI3_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__MOSI3_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__MISO3_net;
	wire [0:0] tmpIO_0__MISO3_net;
	wire [0:0] tmpINTERRUPT_0__MISO3_net;
	electrical [0:0] tmpSIOVREF__MISO3_net;

	cy_psoc3_pins_v1_10
		#(.id("ab247bfc-f548-43f4-b708-fb6571c5aaa5"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		...
		MISO3
		 (.oe(tmpOE__MISO3_net),
		  .y({1'b0}),
		  .fb({Net_166}),
		  .io({tmpIO_0__MISO3_net[0:0]}),
		  .siovref(tmpSIOVREF__MISO3_net),
		  .interrupt({tmpINTERRUPT_0__MISO3_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__MISO3_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__SCLK3_net;
	wire [0:0] tmpFB_0__SCLK3_net;
	wire [0:0] tmpIO_0__SCLK3_net;
	wire [0:0] tmpINTERRUPT_0__SCLK3_net;
	electrical [0:0] tmpSIOVREF__SCLK3_net;

	cy_psoc3_pins_v1_10
		#(.id("19f86136-d1bc-42ef-b5ef-53443b83cbc6"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		...
		SCLK3
		 (.oe(tmpOE__SCLK3_net),
		  .y({Net_164}),
		  .fb({tmpFB_0__SCLK3_net[0:0]}),
		  .io({tmpIO_0__SCLK3_net[0:0]}),
		  .siovref(tmpSIOVREF__SCLK3_net),
		  .interrupt({tmpINTERRUPT_0__SCLK3_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__SCLK3_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	cy_psoc3_pins_v1_10
		#(.id("3a7eba72-095b-43ab-bc67-32a50ac14f3d"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	wire [0:0] tmpOE__DC3_net;
	wire [0:0] tmpFB_0__DC3_net;
	wire [0:0] tmpIO_0__DC3_net;
	wire [0:0] tmpINTERRUPT_0__DC3_net;
	electrical [0:0] tmpSIOVREF__DC3_net;

	cy_psoc3_pins_v1_10
		#(.id("95115d28-e9ca-4d47-a7d7-9ac4b60225d8"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		...
		DC3
		 (.oe(tmpOE__DC3_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__DC3_net[0:0]}),
		  .io({tmpIO_0__DC3_net[0:0]}),
		  .siovref(tmpSIOVREF__DC3_net),
		  .interrupt({tmpINTERRUPT_0__DC3_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__DC3_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	cy_psoc3_pins_v1_10
		#(.id("d4a7d3d8-5f3d-4e46-a5a2-4ce536ffcdf6"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	wire [0:0] tmpOE__RESET3_net;
	wire [0:0] tmpFB_0__RESET3_net;
	wire [0:0] tmpIO_0__RESET3_net;
	wire [0:0] tmpINTERRUPT_0__RESET3_net;
	electrical [0:0] tmpSIOVREF__RESET3_net;

	cy_psoc3_pins_v1_10
		#(.id("d6883d9c-db86-40b4-9931-aff84b40d80b"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		RESET3
		 (.oe(tmpOE__RESET3_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__RESET3_net[0:0]}),
		  .io({tmpIO_0__RESET3_net[0:0]}),
		  .siovref(tmpSIOVREF__RESET3_net),
		  .interrupt({tmpINTERRUPT_0__RESET3_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__RESET3_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	cy_psoc3_pins_v1_10
		#(.id("4022b2bd-65c9-4625-ad4d-291610976ca0"),
		  .drive_mode(3'b010),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
	...
	cy_clock_v1_0
		#(.id("04c58bc9-7bc4-46d9-a269-bd37a07bbbd6"),
		  .source_clock_id(""),
		  .divisor(0),
	...
	wire [0:0] tmpOE__LED_MODE_1_net;
	wire [0:0] tmpFB_0__LED_MODE_1_net;
	wire [0:0] tmpIO_0__LED_MODE_1_net;
	wire [0:0] tmpINTERRUPT_0__LED_MODE_1_net;
	electrical [0:0] tmpSIOVREF__LED_MODE_1_net;

	cy_psoc3_pins_v1_10
		#(.id("afc6febd-e509-4268-8013-9827bd398bee"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		LED_MODE_1
		 (.oe(tmpOE__LED_MODE_1_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__LED_MODE_1_net[0:0]}),
		  .io({tmpIO_0__LED_MODE_1_net[0:0]}),
		  .siovref(tmpSIOVREF__LED_MODE_1_net),
		  .interrupt({tmpINTERRUPT_0__LED_MODE_1_net[0:0]}),
		  .annotation({Net_359}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
	...
	assign tmpOE__LED_MODE_1_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	wire [0:0] tmpOE__LED_MODE_2_net;
	wire [0:0] tmpFB_0__LED_MODE_2_net;
	wire [0:0] tmpIO_0__LED_MODE_2_net;
	wire [0:0] tmpINTERRUPT_0__LED_MODE_2_net;
	electrical [0:0] tmpSIOVREF__LED_MODE_2_net;

	cy_psoc3_pins_v1_10
		#(.id("ca267eda-ea0e-4468-aada-995fa63c2cee"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		LED_MODE_2
		 (.oe(tmpOE__LED_MODE_2_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__LED_MODE_2_net[0:0]}),
		  .io({tmpIO_0__LED_MODE_2_net[0:0]}),
		  .siovref(tmpSIOVREF__LED_MODE_2_net),
		  .interrupt({tmpINTERRUPT_0__LED_MODE_2_net[0:0]}),
		  .annotation({Net_366}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
	...
	assign tmpOE__LED_MODE_2_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	cy_psoc3_pins_v1_10
		#(.id("41e92b6c-b1e1-44aa-9f77-70d32cffc471"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_clock_v1_0
		#(.id("b8946b42-4fcf-43cf-a4ff-a404c37c5ebb"),
		  .source_clock_id(""),
		  .divisor(0),
	...
	cy_clock_v1_0
		#(.id("ee8be36b-f91c-478d-9afd-1d2e56887920"),
		  .source_clock_id(""),
		  .divisor(0),

...
*
* \funcusage
*  \snippet POT_IN_SUT.c usage_POT_IN_Write
*******************************************************************************/
...
*
* \funcusage
*  \snippet POT_IN_SUT.c usage_POT_IN_SetDriveMode
*******************************************************************************/
...
*
* \funcusage
*  \snippet POT_IN_SUT.c usage_POT_IN_Read  
*******************************************************************************/
...
* preferred POT_IN_Read() API because the 
* POT_IN_ReadDataReg() reads the data register instead of the status 
...
*
* \funcusage
*  \snippet POT_IN_SUT.c usage_POT_IN_ReadDataReg 
*******************************************************************************/
...
/* If interrupt is connected for this Pins component */ 
    ...
    /*******************************************************************************
    * Function Name: POT_IN_SetInterruptMode
    ****************************************************************************//**
    *
    ...
    *  component. Or you may use POT_IN_INTR_ALL to configure the
    *  interrupt mode of all the pins in the Pins component.       
    *  - POT_IN_0_INTR       (First pin in the list)
    *  - POT_IN_1_INTR       (Second pin in the list)
    *  - ...
    *  - POT_IN_INTR_ALL     (All pins in Pins component)
    *
    * \param mode
    ...
    *
    * \funcusage
    *  \snippet POT_IN_SUT.c usage_POT_IN_SetInterruptMode
    *******************************************************************************/
    void POT_IN_SetInterruptMode(uint16 position, uint16 mode)
    {
		if((position & POT_IN_0_INTR) != 0u) 
		{ 
			 POT_IN_0_INTTYPE_REG = (uint8)mode; 
		}
    }
    ...
    *
    * \funcusage
    *  \snippet POT_IN_SUT.c usage_POT_IN_ClearInterrupt
    *******************************************************************************/
